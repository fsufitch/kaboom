...
func TestKingCastleShort(t *testing.T) {
	game := newTestGame([]*kaboomproto.ChessPiece{
		...
		newTestPiece("white-rook-h", kaboomproto.PieceKind_ROOK, kaboomproto.Color_COLOR_WHITE, 0, 7),
	}, nil)
	...
	expected := newTestGameProto([]*kaboomproto.ChessPiece{
		newTestPiece("white-king", kaboomproto.PieceKind_KING, kaboomproto.Color_COLOR_WHITE, 0, 6),
		newTestPiece("white-rook-h", kaboomproto.PieceKind_ROOK, kaboomproto.Color_COLOR_WHITE, 0, 5),
	}, nil)
...
func TestKingCastleLong(t *testing.T) {
	...
	game := newTestGame([]*kaboomproto.ChessPiece{
		newTestPiece("black-king", kaboomproto.PieceKind_KING, kaboomproto.Color_COLOR_BLACK, 7, 4),
		newTestPiece("black-rook-a", kaboomproto.PieceKind_ROOK, kaboomproto.Color_COLOR_BLACK, 7, 0),
	}, turns)
	...
	expected := newTestGameProto([]*kaboomproto.ChessPiece{
		newTestPiece("black-king", kaboomproto.PieceKind_KING, kaboomproto.Color_COLOR_BLACK, 7, 2),
		newTestPiece("black-rook-a", kaboomproto.PieceKind_ROOK, kaboomproto.Color_COLOR_BLACK, 7, 3),
	}, turns)
